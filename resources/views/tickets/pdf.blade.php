...
<body>
    <div class="ticket-container">
        ...
        <div class="header-row">
            ...
            <div class="ticket-id">ID Tiket: #{{ $ticket->ticket_id }}</div>
            <div class="clearfix"></div>
        </div>

        <!-- Ticket Type and Seat -->
        <div class="section-title">{{ $ticket->ticket_type }} | Kursi {{ $ticket->seat ? $ticket->seat->seat_number : 'N/A' }}</div>
        ...
        <div class="ticket-info-row">
            ...
            <div class="ticket-value">{{ $event->location ?? 'UGM Yogyakarta' }}</div>
        </div>
        <div class="ticket-info-row">
        ...
        <!-- Simplified Verification Box (QR code removed) -->
        <div class="verification-box">
            <div style="margin-top: 10px; text-align:center;">
                <strong>Ticket Verification Code:</strong><br>
                {{ $ticket->ticket_id }}
            </div>
        </div>
        ...
        <div class="ticket-footer">
            ...
            <ul>
                ...
                <li class="terms-item">Jaga keamanan data tiket anda. Pencurian data diluar hal teknis, diluar tanggung jawab kami</li>
            </ul>
        </div>
    </div>
</body>
