    ...
    <div class="email-container">
        ...
        <div class="content">
                ...
                <div class="info-grid">
                    ...
                    <div class="event-info">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px; margin-top: 15px;">
                            <div>
                                <div style="font-size: 12px; color: {{ $primaryColor }}; font-weight: 600; margin-bottom: 5px;">📍 LOCATION</div>
                                <div style="font-size: 14px;">{{ $event->location ?? 'TBA' }}</div>
                            </div>
                            <div>
                                <div style="font-size: 12px; color: {{ $primaryColor }}; font-weight: 600; margin-bottom: 5px;">📅 DATE</div>
                                <div style="font-size: 14px;">{{ $event->getEventDate() ?? 'TBA' }}</div>
                            </div>
                            <div>
                                <div style="font-size: 12px; color: {{ $primaryColor }}; font-weight: 600; margin-bottom: 5px;">🕒 TIME</div>
            ...
            <div class="tickets-section">
                ...
                <div style="margin-top: 20px; padding: 15px; background: linear-gradient(135deg, {{ $primaryColor }}10, {{ $secondaryColor }}10); border-radius: 10px; border: 1px solid {{ $primaryColor }}30;">
                    <div style="font-size: 12px; color: {{ $primaryColor }}; font-weight: 600; margin-bottom: 5px;">📱 IMPORTANT</div>
                    <div style="font-size: 13px; line-height: 1.5;">
                        Your e-tickets will be sent separately to your email. Please check your inbox and present them at the venue entrance.
                    </div>
                </div>
            </div>
            ...
            <div class="cta-section">
                ...
                <div style="margin-top: 25px; display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px;">
                    <div style="text-align: center; padding: 15px;">
                        <div style="width: 40px; height: 40px; background: {{ $primaryColor }}20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 10px;">
                    ...
                    <div style="text-align: center; padding: 15px;">
                        <div style="width: 40px; height: 40px; background: {{ $secondaryColor }}20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 10px;">
            ...
            <!-- Customer Support -->
            <div style="background: rgba(255, 255, 255, 0.95); border-radius: 15px; padding: 25px; margin-bottom: 30px; border: 2px solid {{ $primaryColor }}30;">
                <h3 style="color: {{ $primaryColor }}; font-size: 16px; margin-bottom: 15px; display: flex; align-items: center;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 10px;">
                    <a href="mailto:support@example.com" style="display: flex; align-items: center; padding: 8px 12px; background: {{ $primaryColor }}10; color: {{ $primaryColor }}; text-decoration: none; border-radius: 8px; font-size: 12px; font-weight: 600;">
                        <svg style="width: 14px; height: 14px; margin-right: 6px; fill: {{ $primaryColor }};" viewBox="0 0 24 24">
                            <path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z"/>
                        </svg>
                        Email Support
                    </a>
                    <a href="tel:+1234567890" style="display: flex; align-items: center; padding: 8px 12px; background: {{ $secondaryColor }}10; color: {{ $secondaryColor }}; text-decoration: none; border-radius: 8px; font-size: 12px; font-weight: 600;">
                        <svg style="width: 14px; height: 14px; margin-right: 6px; fill: {{ $secondaryColor }};" viewBox="0 0 24 24">
