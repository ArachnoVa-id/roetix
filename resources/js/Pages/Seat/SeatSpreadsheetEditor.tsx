...
import { Category, Layout, SeatItem, SeatStatus } from './types';
...
const SeatSpreadsheetEditor: React.FC<Props> = ({ layout }) => {
    ...
    const { setData, post, processing } = useForm({
        seats: JSON.parse(JSON.stringify([] as SeatItem[])),
    });
    ...
    useEffect(() => {
        ...
        const seatItems = layout.items
            ...
            .sort((a, b) => {
                ...
                const rowA =
                    typeof a.row === 'string' ? a.row.charCodeAt(0) : a.row;
                const rowB =
                    typeof b.row === 'string' ? b.row.charCodeAt(0) : b.row;
            ...
            <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        disabled={
                            processing ||
                            !seats.some((seat) => seat.isDirty || seat.isNew)
                        }
                        title="Save changes"
                    >
                        <Save size={20} />
